...
static const char *fonts[]          = { "JetBrains Mono Medium:size=10.5", "JoyPixels:pixelsize=14:antialias=true:autohint=true" };
...
static const char *edwmbcmd[] = { "kitty", "-e", "nvim", "/home/peter/dwm\ shenanigans/Luke\ Smith\'s\ dwmblocks/config.h", NULL};
...
//	{ MODKEY,			XK_F12,		spawn,		SHCMD("remaps & notify-send \\\"⌨️ Keyboard remapping...\\\" \\\"Re-running keyboard defaults for any newly plugged-in keyboards.\\\"") },
	...
	//{ MODKEY|ShiftMask,		XK_Print,	spawn,		SHCMD("dmenurecord kill") },<F11><F12>
...
#endif
	{ ClkStatusText,        ShiftMask,      Button3,        spawn,          {.v = edwmbcmd} },
